require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/cross2.js', '../static/utils/js/charf.js', '../static/utils/js/base/jquery.treeview', '../static/utils/js/pickPeopleWeb'
    ...
    HTML = {
        ...
        TableModeCommitDetail: [
            ...
            '<td data-title="MaintainResultName" data-value="{{MaintainResultName}}" >{{MaintainResultName}}</td>',
            '<td data-title="UpFlowName" data-value="{{UpFlowName}}" >{{UpFlowName}}</td>',
            '<td data-title="CreateTimeText" data-value="{{CreateTimeText}}" >{{CreateTimeText}}</td>',
            '<td data-title="SubmitTime" data-value="{{SubmitTime}}" >{{SubmitTime}}</td>',
    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#lmvt-search", "click", function () {
                ...
                mMaintainResult = $(".search-content-MaintainResult").val() == 0 ? -1 : $(".search-content-MaintainResult").val();
        ...
        run: function () {
            ...
            var selectMaintainResult_search = $("#slpMaintainResult_search");
            model.com.ProcessingData(wMaintainResultList, selectMaintainResult_search);

            // var selectDSType_search = $("#slpDSType_search");
            // model.com.ProcessingData(wDSTypeList, selectDSType_search);
                ...
                model.com.getDeviceLedger({
                    ...
                    model.com.getFMCLine({ FactoryID: 0, BusinessUnitID: 0, WorkShopID: 0 }, function (resP) {
                        ...
                        model.com.getFMCWorkShop({
                            ...
                            model.com.ProcessingData(wFMCWorkShop, selectWorkShopID_search);
        ...
        com: {
            ...
            refreshSend: function (StartTime, EndTime) {
                ...
                model.com.getTaskAll({
                    ...
                    EndTime: EndTime,
                    LedgerID: mLedgerID,
                    MaintainResult: mMaintainResult,
                    DSType: 1,
                    MaintainType: 1,
                    ...
                    for (var k = 0; k < wData.length; k++) {
                        ...
                        if (wData[k].MaintainResult == 1) {
                            wData[k].MaintainResultName="合格";
                        }else if(wData[k].MaintainResult == 2){
                            wData[k].MaintainResultName="不合格";
                        }else{
                            wData[k].MaintainResultName="无";
                        }
                    }
                ...
                if (mQueryTaskID <= 0) {
                    ...
                    model.com.getDeviceInfo({ ID: mDevice }, function (res) {
                        ...
                        model.com.getMaintainItem({
                            IPTMode: 18, BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: 0, PartID: -1, PartPointID: -1, StationID: 0, ProductID: res.info.ModelID
                        }, function (res) {
                            StandardInfo = res.info;
                            model.com.getItemAll({
                                DSType: 1, MaintainType: 1, ModelID: mModelID, FactoryID: -1, WorkShopID: mWorkShopID, LineID: mLineID, Active: -1,
                            }, function (res) {
            ...
            BuinessDetail: function (wInfo, type) {
                if (type == 1) {
                    $(".headerAll .BasicTable .FieldContentOne .Contentshow").text("待发起设备保养");
                } else {
