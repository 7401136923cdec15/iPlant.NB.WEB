require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base'], function ($zace, $com) {
    ...
    HTML = {
        ...
        TablePositionTd_C27: [
            // '<td style="border: 1px solid gray;width: 100%;">',
            '<div style="margin-right: 2%; width: 30%;height: 18px;border-radius: 8px;border: 2px solid #cccccc;color: white;float: right;margin-left: 1%;background-color: {{Color}};">',
            '<p style="font-size: 0.4vw;line-height: 1vw;vertical-align: middle;">{{PartNo}}</p>',
            '</div>',
            // '</td>',
        ].join(""),
        // A1-A7 B1-B7 厂线
