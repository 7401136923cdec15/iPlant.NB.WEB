require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/base/route_new'], function ($zace, $com, $route) {
    ...
    HTML = {
        TableMode: [
            ...
            '<td  data-title="DefaultOrder" data-value="{{DefaultOrder}}" >{{DefaultOrder}}</td>',
    ...
    (function () {
        KEYWORD_Level_LIST = [
            ...
            "Code|工序ID",
            "PartPointID|工序名称|ArrayOne",
            "PrevStepID|前置工序|ArrayOne",
            "NextID|后工序|Array",
            "OrderID|节点顺序号",
            "ActualPeriod|工序工时",
