    ...
    model = $com.Model.create({
        ...
        events: function () {          
            ...
            $("body").delegate("#zace-open-FirstRoute", "click", function () {
                ...
                var vdata = { 'header': '一级流程', 'href': './factory_model/FPCRouteFirstSettingTest.html?id='+SelectData[0].ID, 'id': 'FPCRoutePart', 'src': './static/images/menu/newfactoryModel/techniquePart.png' };
