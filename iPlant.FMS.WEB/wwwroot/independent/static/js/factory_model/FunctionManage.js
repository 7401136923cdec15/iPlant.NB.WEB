    ...
    function ($lin, $com, $page, $jqui) {
        ...
        HTML = {
            ...
            CodeList: [
                ...
                '<td style="min-width: 50px" data-title="DispatchType" data-value="{{DispatchType}}">{{DispatchType}}</td>',
                '<td style="min-width: 50px" data-title="Status" data-value="{{Status}}"><span class="badge lmvt-badge {{ClassBadge}}">{{Badge}}</span>{{Status}}</td>',
                ...
                '<div class="col-md-4 lmvt-code-edit lmvt-do-info lmvt-reset">修改</div>',
                '<div class="col-md-4 {{ISDo}}">{{ActiveType}}</div>',
        ...
        (function () {
            ...
            KETWROD_LIST_Code = [
                ...
                "DispatchType|是否关联任务|ArrayOne",
            ];

            KETWROD_Code = {};

            Formattrt_Code = {};
            // 0 默认   1 无需任务  2需要任务才生成
            TypeSource_Code = {
        ...
        model = $com.Model.create({
            ...
            events: function () {
                ...
                $("body").delegate(".lmvt-reset", "click", function () {
                    ...
                    const Defaul_Value = {
                        ...
                        DispatchType: SelectArr.DispatchType
                    };
                    ...
                    $("body").append($com.modal.show(Defaul_Value, KETWROD_Code, "新增", function (rst) {
                        ...
                        SelectArr.DispatchType = Number(rst.DispatchType);

                        $com.util.deleteLowerProperty(SelectArr);
                        model.com.postBMMFunctionUpdate({
                            data: SelectArr,
                        }, function (res) {
                            alert("修改成功！！");
                            model.com.refresh();
                ...
                $("body").delegate("#lmvt-encoding-add", "click", function () {
                    ...
                    $("body").append($com.modal.show(Defaul_Value_Code, KETWROD_Code, "新增", function (rst) {
                        ...
                        var _data = {
                            ...
                            DispatchType: Number(rst.DispatchType),
                        };
                        model.com.postBMMFunctionUpdate({
                            data: _data,
                        }, function (res) {
                ...
                $("body").delegate(".lmvt-container-main-encoding .lmvt-allowed-delete", "click", function () {
                    ...
                    model.com.postBMMFunctionDelete({
                        data: SelectObj,
                    }, function (res) {
                        alert("删除成功！！");
                        model.com.refresh();
                ...
                $("body").delegate(".lmvt-container-main-encoding .lmvt-do-active", "click", function () {
                    ...
                    model.com.postBMMFunctionActive({
                        data: SelectArr,
                        Active: 1
                    }, function (res) {
                        alert("激活成功！！");
            ...
            com: {
                ...
                //激活编码规则 单条
                postBMMFunctionActive: function (data, fn, context) {
                    var d = {
                        $URI: "/BMMFunction/Active",
                        $TYPE: "post",
                    };
                    function err() {
                        $com.app.tip('获取失败，请检查网络');
                ...
                //删除班组 单条
                postBMMFunctionDelete: function (data, fn, context) {
                    var d = {
                        $URI: "/BMMFunction/Delete",
                        $TYPE: "post",
                    };
                    function err() {
                        $com.app.tip('获取失败，请检查网络');
                ...
                //新增班组
                postBMMFunctionUpdate: function (data, fn, context) {
                    var d = {
                        $URI: "/BMMFunction/Update",
                        $TYPE: "post",
                    };
                    function err() {
                        $com.app.tip('获取失败，请检查网络');
                ...
                refresh: function () {
                    //职能列表
                    model.com.getBMMFunctionAll({ WorkShopID: wWorkShopID, LineID: wLineID, Active: wActive }, function (res) {
                ...
                RendarRuleDefine: function (TeamID) {
                    ...
                    // RuleID = DBID;
                    // , StationID: wStationID, WorkShopID: wWorkShopID
                    // , DepartmentID: wDepartmentID, ModuleID: wModuleID, LineID: wLineID, PartID: wPartID,
                    // PartPointID: wPartPointID, Active: wActive
