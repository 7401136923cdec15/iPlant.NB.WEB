    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-Device-addType", "click", function () {
                ...
                var SelectData = $com.table.getSelectionData($("#femi-Device-tbody-Type"), "WID", WXType);
            ...
            model.com.getDeviceRepairType({
                ...
                $.each(res1.list, function (i, item) {
                    ...
                    model.com.getDeviceModel({
                        ...
                        ControllerPropertyID: 0, Active: -1, SupplierModelNo: "", SystemVersion: "", ControllerModel: ""
                    }, function (res1) {
