        ...
        com: {
            refresh: function () {
                model.com.getDeviceMaintainTask({
                    ModelID: -1, LedgerID: 0, TypeID: 0, OAGetType: 0, ApplicantID: 0, ApproverID: 0, ConfirmID: 0, DSType: 1, StartTime: StartTime,
                    Status: 0, BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1, HasName: 1, EndTime: EndTime,
                }, function (resTask) {
                    if (!resTask)
                        return;
