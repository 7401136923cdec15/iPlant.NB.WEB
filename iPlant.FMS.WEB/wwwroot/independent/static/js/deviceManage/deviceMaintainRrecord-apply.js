 ...
 //	        '<td style="min-width: 50px" data-title="DSType" data-value="{{DSType}}">{{DSType}}</td>  ',
    ...
    $(function () {
        KEYWORD_Device_LIST_Apply = [
         ...
         "ModelID|设备型号|ArrayOneControl|LineID",
    ...
    model = $com.Model.create({
            ...
            $("body").delegate("#zace-add-Device-DSH", "click", function () {
                ...
                $("body").append($com.modal.show(DEFAULT_VALUE_Device_Apply, KEYWORD_Device_Apply, "新增", function (rst) {
                    ...
                    if (rst.TypeIDCustom && rst.TypeIDCustom.trim().length > 0 && Number(rst.TypeID) > 0) {
                        ...
                        //$("body").append($com.modal.show(list, KEYWORD_Device_Apply, "新增", function (rst) {
                    ...
                    model.com.postDeviceMaintainApply({
                        ...
                        alert("新增成功");
                        model.com.getDeviceMaintainType({ ModelID: -1, Name: "", DSType: 1, Active: -1, BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res2) {
        ...
        run: function () {
            ...
            model.com.getDeviceMaintainType({
                ModelID: -1, Name: "", DSType: 1, Active: -1, BusinessUnitID: 0,
        ...
        com: {
            refresh: function () {
                model.com.getDeviceMaintainApply({
                    ModelID: -1, Name: "", TypeID: 0, DSType: 1, Status: 0, LedgerID: 0, StartTime:StartTime,
                    EndTime:EndTime,ApplicantID: 0, ApproverID: 0, ConfirmID: 0, OAGetType: 0
                }, function (resApply) {
                    if (!resApply)
                        return;
