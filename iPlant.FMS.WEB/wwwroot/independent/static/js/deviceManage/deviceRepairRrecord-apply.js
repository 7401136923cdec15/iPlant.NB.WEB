    ...
    model = $com.Model.create({
            ...
            $("body").delegate("#zace-add-Device-DSH", "click", function () {
                $("body").append($com.modal.show(DEFAULT_VALUE_Device_Apply, KEYWORD_Device_Apply, "新增", function (rst) {
                    ...
                    model.com.postDeviceRepairApply({
                        ...
                        alert("新增成功");
                        model.com.getDeviceRepairType({ ModelID: -1, Name: "", DSType: 1, Active: -1, BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1 }, function (res2) {
        ...
        run: function () {
            ...
            model.com.getDeviceRepairType({
                ModelID: -1, Name: "", DSType: 1, Active: -1, BusinessUnitID: -1,
