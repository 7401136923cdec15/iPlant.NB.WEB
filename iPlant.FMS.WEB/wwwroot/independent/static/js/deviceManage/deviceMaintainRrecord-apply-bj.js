            ...
            $("body").delegate("#zace-add-Device-DSH", "click", function () {
                $("body").append($com.modal.show(DEFAULT_VALUE_Device_Apply, KEYWORD_Device_Apply, "新增", function (rst) {
                    ...
                    model.com.postDeviceMaintainApply({
                        ...
                        alert("新增成功");
                        model.com.getDeviceMaintainType({ ModelID: -1, Name: "", DSType: 2, Active: -1, BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res2) {
        ...
        run: function () {
            ...
            model.com.getDeviceMaintainType({
                ...
                model.com.getSpareLedger({
                    ModelID: -1, WorkShopID: 0, LineID: 0, BusinessUnitID: 0, BaseID: 0,
                    FactoryID: 0, Status: 0, DeviceLedgerID: 0, ApplyID: 0
                }, function (res3) {
