    ...
    function ($lin, $com, $treeview) {
        ...
        HTML = {
            ...
            PartStandardList: [
                ...
                '<LI>更多<UL>',
                '<LI data-value="{{ID}}" class="lmvt-version-copy">复制</LI>',
                '<LI data-value="{{ID}}" class="{{ISNow}}">设为当前</LI>',
                '<LI data-value="{{ID}}" class="lmvt-lookInfo">保养规则</LI>',
        ...
        model = $com.Model.create({
            ...
            events: function () {
                ...
                $("body").delegate(".lmvt-lookInfo", "click", function () {
                    ...
                    var vdata = { 'header': '保养规则', 'href': './device_manage/deviceMaintain-rule.html?ID=' + wDBID, 'id': 'deviceMaintain-rule', 'src': '/MESCore/upload/web/维保配置NB.svg' };
                ...
                $("body").delegate(".partPointStandard .lmvt-do-info", "click", function () {
                    ...
                    model.com.getIPTSampleItemAll({
                        ...
                        $('.zaceText').text(SelectObj.Remark + '-设备保养项点');
                        model.com.refreshStandardInfo(StandardID);
                    });
            ...
            run: function () {
                ...
                model.com.getDeviceModelAll({ Active: -1, Type: 1 }, function (res) {

                    GruopAllTree = res.list;

                    model.com.getDeviceLedgerAll({ ModelID: 0, WorkShopID: 0, LineID: 0, BusinessUnitID: 0, BaseID: 0, FactoryID: 0, Active: -1, Type: 1 }, function (resD) {
            ...
            com: {
                ...
                refreshPartAll: function () {
                    model.com.getStandardAll({ IPTMode: IPTMode, BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: 0, PartID: -1, PartPointID: -1, StationID: wModelID, ProductID: wGroupID }, function (res) {
