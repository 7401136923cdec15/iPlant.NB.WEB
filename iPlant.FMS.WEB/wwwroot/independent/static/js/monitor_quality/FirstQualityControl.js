    ...
    function ($lin, $com, $treeview) {
        ...
        (function () {
            ...
            KETWROD_LIST_Item = [
                ...
                // "DefaultManufactor|测量工具|ArrayOne",
                "DefaultManufactor|测量工具编码",
                "IsNumberFill|电容包编号必填|ArrayOne",
        ...
        model = $com.Model.create({
            ...
            events: function () {
                ...
                $("body").delegate(".partPointStandard .lmvt-do-info", "click", function () {
                    ...
                    $('.zaceText').text(SelectObj.Remark + '-质量首检项点');
            ...
            run: function () {
                ...
                model.com.getDeviceInfoAll({
                    ...
                    $.each(res.list, function (i, item) {
                        ...
                        TypeSource_Item.DefaultManufactor.push({
                            name: item.ModelName,
                            value: item.ID
                        });
                    });
            ...
            com: {
                ...
                refreshEditAll: function (fn) {
                    model.com.getStandardPartList({ IPTMode: IPTMode, LineID: wSelectID, ProductID: pSelectIDPro }, function (res) {
                        if (!res) {
                            return;
                        }
                ...
                getStandardPartList: function (data, fn, context) {
                    var d = {
                        $URI: "/IPTStandard/PartVersionAll",
                        $TYPE: "get",
                        $SERVER: '/MESQMS',
                    };
