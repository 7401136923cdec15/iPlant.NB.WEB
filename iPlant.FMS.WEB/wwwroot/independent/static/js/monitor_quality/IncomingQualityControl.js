    ...
    function ($lin, $com, $treeview) {
        ...
        HTML = {
            ...
            PartStandardList: [
                ...
                '<td data-title="DrawingNo" data-value="{{DrawingNo}}" >{{DrawingNo}}</td>',
            ...
            StandardList: [
                ...
                '<td data-title="SpecialFeatures" data-value="{{SpecialFeatures}}">{{SpecialFeatures}}</td>',
                ...
                '<td data-title="IsVerificationFill" data-value="{{IsVerificationFill}}" >{{IsVerificationFill}}</td>',
        ...
        (function () {
            ...
            KETWROD_LIST_Item = [
                ...
                "SpecialFeatures|特殊特性|ArrayOne",

                "DefaultManufactor|量具编码",
                ...
                "IsVerificationFill|核验值必填|ArrayOne",
        ...
        model = $com.Model.create({
            ...
            events: function () {
                ...
                $("body").delegate("#lmvt-standard-add", "click", function () {
                    ...
                    $("body").append($com.modal.show(Defaul_Value_Standard, KETWROD_Standard, "新增版本", function (rst) {
                        ...
                        inputDate = {
                            ...
                            SamplingID: Number(rst.SamplingID),
                            IsCurrent: 0,
                            IsEnd: 0,
                            IsUseD: 0,
                            ItemList: [],
                ...
                $("body").delegate("#lmvt-standarditem-add", "click", function () {
                    ...
                    $("body").append($com.modal.show(Defaul_Value_Item, KETWROD_Item, "新增版本项", function (rst) {
                        ...
                        var _data = {
                            ...
                            IsVerificationFill: rst.IsVerificationFill,
                            SpecialFeatures: rst.SpecialFeatures,
                ...
                $("body").delegate(".partAllStandard .lmvt-do-info", "click", function () {
                    ...
                    var Defaul_Value = {
                        ...
                        IsVerificationFill: SelectData[0].IsVerificationFill,
                        SpecialFeatures: SelectData[0].SpecialFeatures,

                        AQL: SelectData[0].AQL,
                        SamplingPlan: SelectData[0].SamplingPlan,
                    ...
                    $("body").append($com.modal.show(Defaul_Value, KETWROD_Item, "修改版本项", function (rst) {
                        ...
                        $.each(dataSource.ItemList, function (i, item) {
                            if (item.ID == SelectData[0].ID) {
                                ...
                                item.IsVerificationFill = _data.IsVerificationFill;
                                item.SpecialFeatures = _data.SpecialFeatures;

                                item.AQL = _data.AQL;
                                item.SamplingPlan = _data.SamplingPlan;
                                item.DefaultManufactor = rst.DefaultManufactor;
                            }
                        });
                ...
                $("body").delegate(".partPointStandard .lmvt-do-info", "click", function () {
                    ...
                    model.com.getIPTSampleItemAll({
                        ...
                        $('.zaceText').text(SelectObj.Remark + '-来料检验项点');
                ...
                $("body").delegate("#standardList li div:not(.hitarea)", "click", function () {
                    ...
                    //$this.css("background-color", "black");
                    $this.css("background-color", "cornflowerblue");
                    // model.com.refreshStandard(wGroupID);
                    ChangeData = 0;
                    //model.com.StandardItem(GroupID);
                });
            ...
            run: function () {
                ...
                model.com.getMaterialGruopAll({ IsIQCCheck: 1 }, function (res) {

                    var _dataNode = {};
                    model.com.CreateTreeNode(_dataNode, res.list);
                    GruopAllTree = _dataNode.nodes;
                    $("#standardList").treeview({
                        ...
                        onNodeSelected: function (event, data) {
                            ...
                            if (data.Type == "MaterialGroup") {
                                wGroupID = data.ID;
                                wProductID = 0;
                            } else {
                                wGroupID = data.MaterialID;
                                wProductID = data.ID;
                            }
                    ...
                    $com.app.loaded();
                    // $('#standardList').treeview('toggleNodeSelected', [0, { silent: false }]);
                    // $('#standardList').treeview('onClicked', [0, { silent: false }]);

                    // model.com.fullItems(GruopAllTree);
                    // $("#standardList").html($com.util.template(GruopAllTree, HTML.TreeItemNode));
                    // $("#standardList").treeview({ collapsed: false });
            ...
            com: {
                ...
                CreateTreeNode: function (data, list) {
                    if (!data.nodes)
                        data.nodes = [];
                    $.each(list, function (i, item) {
                        var _data = {
                        ...
                        model.com.CreateTreeNode(_data, item.SonList);
                        model.com.CreateTreeNodeItem(_data, item.MaterialList);
                        data.nodes.push(_data);
                    })
                    data.tags = [data.nodes.length];
                },
                CreateTreeNodeItem: function (data, list) {
                    if (!data.nodes)
                        data.nodes = [];
                    $.each(list, function (i, item) {
                        data.nodes.push({
                            text: item.MaterialNo + "(" + item.MaterialName + ")",
                            ID: item.ID,
                            Type: "Material",
                            MaterialID: item.MaterialGroupID
                        });
                    })
                    data.tags = [data.nodes.length];
                },
                ...
                //查询所有物料组
                getMaterialGruopAll: function (data, fn, context) {
                    var d = {
                        $URI: "/Material/GroupAll",
                        $TYPE: "get"
                    };
                ...
                refreshEditAll: function (fn) {
                    model.com.getStandardAll({ IPTMode: IPTMode, BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: wGroupID, PartID: -1, PartPointID: -1, StationID: -1, ProductID: wProductID }, function (res) {
