    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-aotu-checked", "click", function () {
                ...
                model.com.postOMSManualScheduling({
                    ...
                    mApsList.TreeList = $com.util.Clone(res.TreeList);
                    ...
                    $.each(position.Task.data, function (j, jtem) {
                        $.each(jtem.TaskPartList, function (k, ktem) {
                            ...
                            $.each(ktem.TaskPartList, function (m, mtem) {
                                ...
                                mtem.StartTime = $com.util.format("yyyy-MM-dd hh:mm:ss", new Date(mtem.StartTime).getTime());
            ...
            $("body").delegate("#zace-aotu-orderPlan", "click", function () {
                ...
                if (dayZace < CurDays - 1 || dayZace > 45) {
                    ...
                    var msg = "排程天数至少为所选月" + "(" + CurDays + ")" + "天数，且不超过45天！"
                    alert(msg);
                    return false;
                ...
                model.com.postAutoScheduling({
                    ...
                    if (res.MiddleTime > mEndTime) {
                        zaceTime = $com.util.format('yyyy-MM-dd', new Date(res.MiddleTime));
                    } else {
                        zaceTime = mEndTime;
                    }
                    mStartTime = res.StartTime;
                    mEndTime = zaceTime;
                    //渲染甘特数据
                    var AllGantte = $com.util.Clone(res.TreeList);
                    //需要回显数据
        ...
        com: {
            ...
            refresh: function () {
                ...
                model.com.getOMSOrderList({ StartTime: mStartTimeNew, EndTime: mEndTimeNew, APSShiftPeriod: 6 }, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
