require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/base/route_new', '../static/utils/js/base/tooltip', '../static/utils/js/base/Vue', '../static/utils/js/base/paging'], function ($zace, $com, $route, $tooltip, Vue, $page) {
    ...
    (function () {
        ...
        KEYWORD_Level_LIST = [
            ...
            "ColNum|列数量",
            "VolumNum|支数量",
            "SizeUnitID|箱尺寸单位|ArrayOne",
            "BoxLength|箱长",
            "BoxWidth|箱宽",
            "BoxHeight|箱高",

            "VolumUnitID|箱体积单位|ArrayOne",
            "BoxVolum|体积",


            "WeightUnitID|箱重量单位|ArrayOne",
            "NetWeight|净重",
            "GrossWeight|毛重",
    ...
    var app = new Vue({
        ...
        created: function () {
            ...
            VueThis.getUnitAll({ Active: 1 }, function (resP) {
                $.each(resP.list, function (i, item) {
                    TypeSource_Level.SizeUnitID.push({
                        name: item.Name,
                        value: item.ID,
                    });
                    TypeSource_Level.VolumUnitID.push({
                        name: item.Name,
                        value: item.ID,
                    });
                    TypeSource_Level.WeightUnitID.push({
                        name: item.Name,
                        value: item.ID,
                    });
                });
        ...
        methods: {
            ...
            MonInfoAdd: function () {
                ...
                $("body").append($com.modal.show(DEFAULT_VALUE_Level, KEYWORD_Level, "新增", function (rst) {
                    ...
                    var _data = {
                        Code: rst.Code,
                        Name: rst.Name,
                        Material: rst.Material,
                        RowNum: rst.RowNum,
                        ColNum: rst.ColNum,
                        VolumNum: rst.VolumNum,
                        SizeUnitID: rst.SizeUnitID,
                        BoxLength: rst.BoxLength,
                        BoxWidth: rst.BoxWidth,
                        BoxHeight: rst.BoxHeight,
                        VolumUnitID: rst.VolumUnitID,
                        BoxVolum: rst.BoxVolum,
                        WeightUnitID: rst.WeightUnitID,
                        NetWeight: rst.NetWeight,
                        GrossWeight: rst.GrossWeight,
                    }

                    _this.postFPCBoxTypeUpdate({
                        data: _data,
                    }, function (res) {
                        alert("新增成功");
                        _this.refresh();
            ...
            ChangeMonIn: function (ID) {
                ...
                var DEFAULT_VALUE = {
                    ...
                    Material: SelectData.Material,
                    RowNum: SelectData.RowNum,
                    ColNum: SelectData.ColNum,
                    VolumNum: SelectData.VolumNum,
                    SizeUnitID: SelectData.SizeUnitID,
                    BoxLength: SelectData.BoxLength,
                    BoxWidth: SelectData.BoxWidth,
                    BoxHeight: SelectData.BoxHeight,
                    VolumUnitID: SelectData.VolumUnitID,
                    BoxVolum: SelectData.BoxVolum,
                    WeightUnitID: SelectData.WeightUnitID,
                    NetWeight: SelectData.NetWeight,
                    GrossWeight: SelectData.GrossWeight,
                }
                ...
                $("body").append($com.modal.show(DEFAULT_VALUE, KEYWORD_Level, "新增", function (rst) {
                    ...
                    SelectData.Material = rst.Material;
                    SelectData.RowNum = rst.RowNum;
                    SelectData.ColNum = rst.ColNum;
                    SelectData.VolumNum = rst.VolumNum;
                    SelectData.SizeUnitID = rst.SizeUnitID;
                    SelectData.BoxLength = rst.BoxLength;
                    SelectData.BoxWidth = rst.BoxWidth;
                    SelectData.BoxHeight = rst.BoxHeight;
                    SelectData.VolumUnitID = rst.VolumUnitID;
                    SelectData.BoxVolum = rst.BoxVolum;
                    SelectData.WeightUnitID = rst.WeightUnitID;

                    SelectData.NetWeight = rst.NetWeight;
                    SelectData.GrossWeight = rst.GrossWeight;
            ...
            ChangeTableTR: function (ID) {
                ...
                $("body").append($com.modal.show(DEFAULT_VALUE, KEYWORD_Level_Order, "新增", function (rst) {
                    ...
                    SelectData.ProductID = rst.ProductID;
            ...
            deleteMoInfo: function (ID) {
                ...
                if (!confirm("已选择箱体编码为 [" + SelectData.Code + "] 的数据，是否删除？")) {
                    return;
                }
                
                _this.postFPCBoxTypeDelete({
                    data: SelectData,
                }, function (res) {
            ...
            refresh: function () {
                ...
                this.getFPCBoxTypeAll({}, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
                        ...
                        $.each(Grade, function (i, item) {
                            ...
                            item.ColNumAndRowNum = item.RowNum + "*" + item.ColNum;
                            item.SizeUnitAndText = item.BoxLength + "*" + item.BoxWidth + "*" + item.BoxHeight;

                            item.VolumUnitAndText = item.BoxVolum + item.VolumUnitText;

                            item.GrossWeight = item.GrossWeight + item.WeightUnitText;
                            item.NetWeight = item.NetWeight + item.WeightUnitText;
            ...
            postFPCBoxTypeUpdate: function (data, fn, context) {
                var d = {
                    $URI: "/FPCBoxType/Update",
                    $TYPE: "post"
                };
            ...
            //删除规则
            postFPCBoxTypeDelete: function (data, fn, context) {
                var d = {
                    $URI: "/FPCBoxType/Delete",
                    $TYPE: "post"
                };
            ...
            //激活禁用
            postFPCBoxTypeActive: function (data, fn, context) {
                var d = {
                    $URI: "/FPCBoxType/Active",
                    $TYPE: "post"
                };
            ...
            //单体分档参数列表
            getFPCBoxTypeAll: function (data, fn, context) {
                var d = {
                    $URI: "/FPCBoxType/All",
                    $TYPE: "get",
                };
