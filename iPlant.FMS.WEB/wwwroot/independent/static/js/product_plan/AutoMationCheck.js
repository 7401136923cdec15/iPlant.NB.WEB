require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/base/route_new', '../static/utils/js/base/tooltip', '../static/utils/js/base/Vue', '../static/utils/js/base/paging'], function ($zace, $com, $route, $tooltip, Vue, $page) {
    ...
    var app = new Vue({
        ...
        data: {
            ...
            StartTime: $com.util.format("yyyy-MM-dd", new Date().getTime() - 1 * 3600000 * 24),
        ...
        methods: {
            ...
            refresh: function () {
                ...
                _this.getProcessDataByTime({ hasDetail: false, startTime: _this.StartTime, endTime: _this.EndTime }, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
                        ...
                        $.each(Grade, function (i, item) {
                            ...
                            item.tsample = $com.util.format("yyyy-MM-dd hh:mm", item.tsample);
            ...
            //单体分档参数列表
            getProcessDataByTime: function (data, fn, context) {
                var d = {
                    $URI: "/processdata/getProcessDataByTime",
                    $TYPE: "get", 
                };
