require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base'], function ($zace, $com) {
    ...
    HTML = {
        TableMode: [
            ...
            // '<td data-title="LinkManID" data-value="{{LinkManID}}" >{{LinkManID}}</td>',
            '<td data-title="ProPurchaseDur" data-value="{{ProPurchaseDur}}" >{{ProPurchaseDur}}</td>',
            '<td data-title="SupPurchaseDur" data-value="{{SupPurchaseDur}}" >{{SupPurchaseDur}}</td>',
    ...
    (function () {
        KEYWORD_Level_LIST = [
            ...
            "SupplierID|委修厂家|ArrayOne",
            "LinkManID|联系人|ArrayOne",
            "ProPurchaseDur|工艺周期",
            "SupPurchaseDur|委外周期",
            "Status|状态|ArrayOne",
    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-edit-level", "click", function () {
                ...
                var default_value = {
                    ...
                    ProPurchaseDur: SelectData[0].ProPurchaseDur,
                    SupPurchaseDur: SelectData[0].SupPurchaseDur,
                ...
                $("body").append($com.modal.show(default_value, KEYWORD_Level, "修改", function (rst) {
                    ...
                    SelectData[0].ProPurchaseDur = rst.ProPurchaseDur;
                    SelectData[0].SupPurchaseDur = rst.SupPurchaseDur;
                    // SelectData[0].Status = Number(rst.Status);
            ...
            $("body").delegate("#zace-add-level", "click", function () {
                ...
                $("body").append($com.modal.show(DEFAULT_VALUE_Level, KEYWORD_Level, "新增", function (rst) {
                    ...
                    // PositionTemp.SupplierID = Number(rst.SupplierID);
                    // PositionTemp.LinkManID = Number(rst.LinkManID);
                    PositionTemp.ProPurchaseDur = rst.ProPurchaseDur;
                    PositionTemp.SupPurchaseDur = rst.SupPurchaseDur;
        ...
        com: {
            refresh: function () {
                model.com.getAPSDismantling({}, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
            ...
            //查询列表
            getAPSDismantling: function (data, fn, context) {
                var d = {
                    $URI: "/APSDismantling/All",
                    $TYPE: "get",
                    $SERVER: "/MESAPS"
                };
            ...
            //保存列表
            postAPSDismantling: function (data, fn, context) {
                var d = {
                    $URI: "/APSDismantling/Update",
                    $TYPE: "post",
                    $SERVER: "/MESAPS"
                };
