    ...
    model = $com.Model.create({
        ...
        com: {
            refresh: function () {
                ...
                model.com.getAPSHistory({ ShiftDate: mStartTime, TagType: mTagType }, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
                        var Grade = [];
