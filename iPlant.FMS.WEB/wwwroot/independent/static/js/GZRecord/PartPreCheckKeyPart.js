                 ...
                 model.com.getTypeAll({}, function (resP) {
                    ...
                    if (resP && resP.list) {
                        ...
                        $.each(resP.list, function (i, item) {
                            ...
                            if (item.Active == 1) {
                                modalObj[item.Code] = item.Code+'-'+item.Name;
                            ...
                            //申请
                model.com.getPreCheckRecord({ OrderID: mOrderID, StartTime: mStartTime, EndTime: mEndTime, StepID: mStepID, RecordType: mRecordType }, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
                        ...
                        $.each(Grade, function (i, item) {
                            ...
                            item.ItemName=modalObj[item.ItemName];
