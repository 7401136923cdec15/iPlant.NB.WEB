    ...
    model = $com.Model.create({
        ...
        com: {
            ...
            refresh: function () {
                ...
                //申请
                model.com.getPreCheckRecord({ OrderID: mOrderID, StartTime: mStartTime+' 00:00:00', EndTime: mEndTime+' 23:59:59', StepID: mStepID, RecordType: mRecordType }, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
