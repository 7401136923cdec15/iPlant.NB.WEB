require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/base/paging'], function ($zace, $com, $page) {
    ...
    model = $com.Model.create({
        ...
        events: function () {
            window.setFunctionTrigger("PartQTProcessO", function (res) {
            ...
            model.com.getFPCPart({}, function (resP) {
                ...
                if (resP && resP.list) {
                    $.each(resP.list, function (i, item) {
                        if ((item.PartType == 3||item.PartType == 4)&&item.Active==1) {
        ...
        com: {
            ...
            refresh: function () {
                ...
                $('.zace-titleText').text('【'+mPartNo+'】'+'机车质检记录');     
                //申请
                model.com.getProcessRecord({ OrderID: mOrderID }, function (resP) {
                    if (!resP)
                        return;
                    if (resP && resP.list) {
