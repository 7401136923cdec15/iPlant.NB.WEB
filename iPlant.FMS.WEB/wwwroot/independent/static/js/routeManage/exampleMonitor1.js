require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/base/jquery.treeview', ], function ($zace, $com, $tree) {
    ...
    var HTML = {
        TableExampleItemMode: [
            ...
            '<td style="min-width: 30px;max-width: 200px;" data-title="#" data-value="#"><div class="td-contain"><span class="td-contain-list" id="cby-show-charf" >流程图</span><span class="td-contain-list" id="cby-show-record">历史记录</span><span class="td-contain-list" id="cby-on-exa">激活</span><span class="td-contain-list" id="cby-stop-exa">挂起</span><span class="td-contain-list" id="cby-delete-exa">删除</span><span class="td-contain-list" id="cby-show-recordGy">干预记录</span><span class="td-contain-list" id="cby-show-exampleObject" >实例对象</span></div> </td>  ',
    ...
    model = $com.Model.create({
        ...
        events:function(){
            ...
            //查看实例对象
            $("body").delegate("#cby-show-exampleObject", "click", function () {
                var _dataProcessDefine = $com.util.Clone(DataTable);
                var tid, ProcessInstanceID, _status;
                tid = $(this).closest("td").next().next().attr("data-value");
                $.each(dataExample, function (i, item) {
        ...
        com:{
            ...
            getExample: function (data, fn, context) {
                var d = {
                    $SERVER:"/MESBPM",
                    $URI: "/Leave/GetRunProcessInstance",
                    $TYPE: "get"
                };
            ...
            getExampleObject: function (data, fn, context) {
                var d = {
                    $SERVER: "/MESBPM",
                    $URI: "/Leave/GetExecutionByProcessInstance",
                    $TYPE: "get"
                };
