require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/base/jquery.treeview', ], function ($zace, $com, $tree) {
    ...
    var HTML = {
        TableExampleItemMode: [
            ...
            '<td style="min-width: 30px;max-width: 70px;" data-title="#" data-value="#"><div class="td-contain"><span class="td-contain-list" id="cby-show-charf" >查看流程图</span><span class="td-contain-list" id="cby-show-record">历史记录</span></div> </td>  ',
    ...
    model = $com.Model.create({
        ...
        events:function(){
            ...
            $("body").delegate("#cby-show-charf","click",function(){
                ...
                var $src=$com.routeUrl+"/MESBPM/api/leave/image?processInstanceId="+ProcessInstanceID;
            ...
            //历史记录模糊查询
            $("body").delegate("#cby-searchRecord-table", "change", function () {
                var $this = $(this),
                    value = $(this).val();
        ...
        com:{
            ...
            refreshRecord:function(tid){
                var showObj={},
                    showArr=[];
                model.com.getExampleRecord({executionId:tid},function(res){
                    dataRecord=res.list;
