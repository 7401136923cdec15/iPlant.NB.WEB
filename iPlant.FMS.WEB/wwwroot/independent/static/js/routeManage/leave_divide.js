    ...
    model = $com.Model.create({
        ...
        events:function(){
            ...
            $("body").delegate("#cby-submit-data","click",function(){
                ...
                //     }
                // });
                model.com.onTask({id:taskIDObj.defineID},function(res){
                    var _defineID=res.info;
                   
                    model.com.getCurrentData({processInstanceId:_defineID},function(res){
                        dataCurrent=res;
                        var _TaskID=dataCurrent.info;
                        model.com.postTask({TaskID:_TaskID,data:_data,IsStart:true},function(){
                            alert("任务启动成功！！")
                        });
                    });
                });
