define(['./jquery-3.1.1', './base/base'], function ($jQ, $com) {
    ...
    var install = function (ContainDiv, ScrollContainDiv, positionIn) {
        ...
        // $canvasLeft.scroll(function (event) {
           

        //     window.Gantt_GUD_L = 1;
        //     var $this = $(this);
        //     var ScrollDiv = ScrollContainDiv;
        //     var scroH = $this.scrollTop();  //滚动高度
        //     if (scroH > $this[0].scrollHeight) {
        //         scroH = $this[0].scrollHeight;
        //     } 
        //     var scroW = $this.scrollLeft();
        //     if(ScrollDiv.scrollTop()!=scroH){
    ...
    var CanvasBasic = function () {
        ...
        contexttop.fillText("工位", 80, 49);


        contexttop.fillText("修程", 200, 49);
        contexttop.fill();
        contexttop.closePath();

        //画横线
        contexttop.strokeStyle = 'DarkGray';
        contexttop.moveTo(0, 35);
        contexttop.lineTo(canvas.width + freedom, 35);
        contexttop.moveTo(0 + freedom, 35);
        contexttop.lineTo(canvas.width + freedom, 35);
        contexttop.stroke();
        contexttop.closePath();
    ...
    var DrawPart = function (TOPHEIGHT, jtem) {
        ...
        contextleft.font = "bold 13px Arial";
        contextleft.fillStyle = 'black';
        contextleft.fillText(jtem.PartName, 30, (TOPHEIGHT - PARTHEIGHT) / 2 + PARTHEIGHT);
        contextleft.fill();
        contextleft.closePath();
