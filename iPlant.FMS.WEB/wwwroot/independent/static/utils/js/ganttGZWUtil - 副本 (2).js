define(['./jquery-3.1.1', './base/base'], function ($jQ, $com) {
    ...
    var ColorClass = ['#8795cc', '#5670d6', '#8f9fe0', '#344aa0', '#E84D3B', '#7E8C8D', '#C59BD7', '#8548A7', '#697787', '#91AB65', '#B0C97D', '#429FC0', '#6D7181', '#b2ce83', '#a4b981', '#7ca932', '#628628', '#c3a1d2', '#c78ee0', '#9c64b5'];
