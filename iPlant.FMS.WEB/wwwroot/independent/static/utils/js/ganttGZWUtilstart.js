define(['./jquery-3.1.1', './base/base'], function ($jQ, $com) {
    ...
    var Tips = function (x, y, index) {
        ...
        var startDate = position.Task.dataList[index].StartTime,
            time = position.Task.dataList[index].EndTime,
            TaskText = position.Task.dataList[index].EndTime,
            APSMessage = position.Task.dataList[index].APSMessage;

            position.tip.Text.tipW=700;
        var tipW = 700;
        var tipH = 100;
        var lineH = 15;
        var titleH = 30;
        var lengthSum = 0;
        position.Task.dataList[index].PartNo= '开始：'+position.Task.dataList[index].StartTime+';结束：'+position.Task.dataList[index].EndTime;
       ...
       // startDate = addDate(startDate, 0);
        ...
        // time=$com.util.format('yyyy-MM-dd hh:mm:ss', time);
        // TaskText=$com.util.format('yyyy-MM-dd hh:mm:ss', TaskText);
