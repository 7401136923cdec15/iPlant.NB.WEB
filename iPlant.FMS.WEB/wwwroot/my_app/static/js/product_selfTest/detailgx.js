        ...
        events: function () {
            ...
            if (window.JSImpl) {
                ...
                $("body").delegate("#confirm", "click", function () {
                    ...
                    window.QRTESTPartNo = function (partNo) {
                        ...
                        model.com.getPart({ Station: wStationID, PartNo: partNo, TaskStepID: model.query.id }, function (res) {
                            ...
                            window.location = "detailEdit.html?id=" + model.query.id + "&sID=" + wStationID + "&sanC=" + wSanc + "&part=" + partNos + "&pack=" + packages;
                ...
                $("body").delegate("#confirm", "click", function () {
                    ...
                    window.location = "detailEdit.html?id=" + WID + "&sanC=" + wSanc + "&part=" + "J190723D0786" + "&pack=" + "160V2019060759";
                });
            }
        },
