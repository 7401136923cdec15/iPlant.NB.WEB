	...
	model = $com.Model.create({
		...
		events: function () {
		    ...
		    $("body").delegate("#resultList #result_confirm", "click", function () {
		        ...
		        model.com.renderItems(model.com.filterItems(MsAll));
		        $("#resultList").hide();
		        ...
		        if (window.JSImpl) {
		            window.QRTEST = function (val) {
		                ...
		                model.com.getScanData({
		                    ...
		                    MsAll = $com.util.Clone(MsAllBasic);
		...
		run : function() {
		    this.com.getItem({
		        ...
		        MsAll = $com.util.Clone(data.list);
		        MsAllBasic = $com.util.Clone(data.list);
		...
		com: {
			...
			addCheck : function(e, close) {
			    ...
			    model.com.add({
			        ...
			        alert("保存成功");
			        window.location = "reportPaDetailSS.html?id=" + data.info.ID;
			...
			addCheckSubmitLZ: function (e, close) {
			    ...
			    model.com.add({
			        ...
			        model.com.add({
			            ...
			            alert("提交成功");
			            window.location = "reportPaDetail.html?id=" + data1.info.ID;
