    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#checkrw", "click", function () {
                if (!window.JSImpl) {
                    ...
                    model.com.getScan({ QRCode: "SP-GJD-326-2019-07-00001" }, function (res) {
                        wledger = "SP-GJD-326-2019-07-00001";
                        //台账ID
            ...
            $("body").delegate(".ms-group", "click", function () {
                    ...
                    if (status == 2) {
                        //填保养结果
                        window.location = "check_bj.html?id=" + id + "&aID=" + applyID + "&status=" + status + "&statustext=" + statustext;
                    } else {
                        window.location = "detail_cl_bj.html?id=" + id + "&aID=" + applyID + "&status=" + status + "&statustext=" + statustext;
                    }
        ...
        com: {
            ...
            getTask: function (data, fn, context) {
                var d = {
                    $URI: "/DeviceMaintainTask/EmployeeAll",
                    $TYPE: "get"
                };
