                        ...
                        for (var i = 0; i < DATA.user.length; i++) {
                            for (var j = 0; j < selected.length; j++) {
                                if (DATA.user[i].PositionID == selected[j]) {
                                    user.push({ ID: 0, LockID: model.query.ID, UserID: DATA.user[i].WorkerID, PositionID: DATA.user[i].PositionID, Status: 0 });
                                }
                            }
                        }
                        for (var i = 0; i < DATA.list.length; i++) {
                                    list.push({ ID: 0, PartPointID: DATA.list[i].PartPointID, PartPointName: DATA.list[i].PartPointName, LockType: 2, Status: 1 });
                        }
