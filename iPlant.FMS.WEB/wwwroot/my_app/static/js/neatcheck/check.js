    ...
    model = $com.Model.create({
        ...
        run: function () {
            ...
            if (model.query.sid && model.query.sid != 0) {
                model.com.get({
                    ID: model.query.id, CheckID: model.query.sid, EventID: 1008,
                }, function (data) {
                    DATA = data.info;
                ...
                model.com.get({
                    ID: model.query.id, EventID: 1008,
                }, function (data) {
                    DATA = data.info;
                    PartList = data.info.MaterialList;
                    $("#m-card").html($com.util.template(data.info, HTML.TITLE));
        ...
        com: {
            ...
            save: function (data, fn, context) {
                var d = {
                    $URI: "/SFCMaterialCheck/TaskPartSave",
                    $TYPE: "post"
                };
                function err() {
                    $com.app.tip('获取失败，请检查网络');
