require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base'], function ($yang, $com) {
    ...
    COLOUR = ["text-yellow", "text-yellow", "text-yellow", "text-red", "text-yellow", "text-yellow", "text-red", "text-yellow", "text-red", "text-yellow", "text-yellow", "text-green", "text-red", ],
    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate(".ms-group", "click", function () {
                var $this = $(this),
                    ...
                    window.location = "checkZZ.html?id=" + id + "&status=" + status;
        ...
        run: function () {
            ...
            model.com.getRework({
                EventID: window._eventID, person_judge: window._person_judge, TagValue: 3,
            }, function (data) {
                TValue = 1;
                var list = data.list;
