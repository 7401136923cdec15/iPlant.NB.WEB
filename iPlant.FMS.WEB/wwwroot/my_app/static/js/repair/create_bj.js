require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base', '../static/utils/js/base/appTools'], function ($yang, $com, $tool) {
    ...
    model = $com.Model.create({
            ...
            $("body").delegate("#commit", "click", function () {
                ...
                desc = $("#desc").val;
                	...
                	if (!window.JSImpl) {
                	    ...
                	    model._data.RepairItemOptions = ItemID;
        ...
        run: function () {
            ...
            modelID = model.query.smodelID;
            ledgerID = model.query.sledgerID;
            ...
            model.com.SpareModel({
                SpareWorkType: 0, SupplierID: 0, ModelPropertyID: 0,
                Active: -1, SupplierModelNo: "",StartTime:"2000-1-1",
                EndTime:"2000-1-1"
            }, function (res) {
                if (window.JSImpl) {
        ...
        com: {
            ...
            SpareModel: function (data, fn, context) {
                var d = {
                    $URI: "/SpareModel/All",
                    $TYPE: "get",
                };
                ...
                confirm("确认提交吗？", function (bool) {
                    if (bool == true) {
                        model.com.save(data, function (res) {
                            IsSubmit = false;
                            alert("提交成功");
                            window.location = "apply_bj.html?id=" + res.info.ID;
                        });
                    } else {
                        return false;
                    }
