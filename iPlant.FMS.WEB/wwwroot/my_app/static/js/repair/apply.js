require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base'], function ($yang, $com) {
    ...
    COLOUR = ["text-grey", "text-yellow", "text-red", "text-blue", "text-red", "text-green"];
        HTML = {
            LIST: ['<div class="ms-group clearfix" data-id="{{ID}}" data-apply="{{ApplyNo}}"data-statustext="{{StatusText}}"  data-status="{{Status}}">',
			...
			'<span class="ms-field"><span class="ms-label">申请人:</span>',
			'<span class="ms-text">{{ApplicantName}}</span> </span>',
			'</div>',
            '<div class="ms-sub-title">',
        ...
        events: function () {
            ...
            $("body").delegate("#checksq", "click", function () {
                if (!window.JSImpl) {
                    ...
                    //model.com.getScan({ QRCode: "DE-M74839-2019-05-00000" }, function (res) {
                    //    wledger = "DE-M74839-2019-05-00000";
                    //    //台账ID
            ...
            $("body").delegate(".ms-group", "click", function () {
                ...
                window.location = "detail_apply.html?id=" + id + "&aID=" + applyno + "&status=" + status + "&statustext=" + statustext;
            });
