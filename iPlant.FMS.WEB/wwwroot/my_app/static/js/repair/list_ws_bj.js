require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base'], function ($yang, $com) {
    ...
    COLOUR = ["text-grey", "text-yellow", "text-red", "text-green", "text-red", "text-green"];
    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate(".ms-group", "click", function () {
                ...
                window.location = "detail_ws_bj.html?id=" + id + "&aID=" + applyno + "&status=" + status + "&statustext=" + statustext;
            });
