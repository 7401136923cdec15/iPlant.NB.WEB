require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base'], function ($yang, $com) {
    ...
    HTML = {
        LIST1: [
           '<div class="ms-group clearfix" data-id="{{ID}}" data-check="{{UnLockUser}}" data-status="{{StatusName}}" data-calluser="{{NCRUserID}}">',
    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate(".ms-group", "click", function () {
                ...
                window.location = "checkTZ.html?id=" + id + "&status=" + status + "&calluserID=" + calluserID;
