...
namespace iPlant.SCADA.Service
{
    public class QMSSpotCheckRecordDAO : BaseDAO
    {
        ...
        public List<QMSSpotCheckRecord> GetAll(BMSEmployee wLoginUser, String wOrderNo,
                List<int> wProductIDList, String wWorkpieceNo, String wSpotCheckResult, int wLineID, String wStartTime, String wEndTime, int wPageSize, int wPageIndex, int wPaging, OutResult<Int32> wPageCount, OutResult<Int32> wErrorCode)
        {
